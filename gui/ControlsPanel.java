...
public class ControlsPanel extends JPanel implements ActionListener{
    ...
    public ControlsPanel(ArenaPanel arenaPanel) {
        ...
        CompArenaWeather.setLocation(10, 155); // Adjust the location as needed
        ...
        buildArenaBut.setSize(150, 20);
        buildArenaBut.addActionListener(this);
        add(buildArenaBut);
        
        JSeparator sep = new JSeparator(SwingConstants.HORIZONTAL);
        sep.setLocation(0,197);
        sep.setSize(170, 10);
        add(sep);
        ...
        switch (e.getActionCommand()) {
				...
				case "Build arena":  
                    ...
                    if ("Summer".equals(CompArenaWeather.getSelectedItem())) {
                        JOptionPane.showMessageDialog(this, "The summer arena is not valid right now.", "Invalid Selection", JOptionPane.WARNING_MESSAGE);
